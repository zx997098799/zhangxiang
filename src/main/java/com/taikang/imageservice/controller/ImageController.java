...
public class ImageController {
    ...
    public ResponseMessage getInfo(@RequestBody HuoquImageBo huoquImageBo) throws NoSuchAlgorithmException {
        ...
        md5.update(srcBytes);
        byte[] resultBytes123456 = md5.digest();
        String resultString = new String(new Hex().encode(resultBytes123456));
        ...
        System.out.println("3期的第二次修改");
        System.out.println("3期的第3次修改");
        System.out.println("3期的第4次修改");
